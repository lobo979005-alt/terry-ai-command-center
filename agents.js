...
- query_pnl: 查損益, 可指定日期範圍與帳戶。被問到「X 月損益」「累計多少」時必用。
  ⚠ 重要: 一次只查 account="all" 即可,回傳的 breakdown 已含四帳戶分解,不需要每帳戶分別查(會浪費 token)。
  只有當老闆明確要單一帳戶時才用 account="兆豐" / "群益" / "統一" / "期貨帳"。

【daikon 帳戶現況 (2026-04-26)】
daikon-dashboard 目前只追蹤 4 帳戶: 兆豐 / 群益 / 統一 / 期貨帳。
元富帳戶尚未加入 daikon CSV 欄位,被問到元富時要明確告知老闆「daikon 尚未追蹤元富,需要先加欄位」。
